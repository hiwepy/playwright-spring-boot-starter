...
public class PlaywrightProperties {
	...
	private GenericObjectPoolConfig<BrowserContext> browserPoolConfig = new GenericObjectPoolConfig<>();

	private GenericObjectPoolConfig<Page> pagePoolConfig = new GenericObjectPoolConfig<>();
